...
| `korgex skills` | List skills; `install <ref>` / `search <query>` / `adopt <dir>` pull from the open [Agent-Skills catalog](https://skills.sh) (local dir, git URL, or `owner/repo[@skill]`) as `trust: installed`. |
