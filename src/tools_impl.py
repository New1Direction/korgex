...
def tool_run_test_with_self_healing(test_command: str, target_file: str, context_files: list = None, context: dict = None):
    ...
    try:
        ...
        client = OpenAI(
            base_url=os.environ.get("KORGEX_API_URL", "https://inference-api.nousresearch.com/v1"),
...
def tool_google_search(query: str, context: dict = None):
    ...
    try:
        ...
        return {"error": "web_search not available. Install hermes_tools or configure a search provider."}
